...
<div class="modal fade" id="kt_modal_add_videos" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="kt_modal_add_videos_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Add Video</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <!--end::Modal header-->
            <!--begin::Modal body-->
            <div class="modal-body scroll-y mx-5 mx-xl-5 my-1" id="kt_modal_body_add_videos">
                <!--begin::Form-->
                <form id="kt_modal_add_videos_form" class="form" action="/videos" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_videos_scroll"
                        data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}"
                        data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_videos_header"
                        data-kt-scroll-wrappers="#kt_modal_add_videos_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div id="thumbnailContainer" class="previewImage"
                                style="margin-top: 10px; margin-bottom: 10px;"></div>

                            <!--begin::Input-->
                            <input type="text" id="youtubeLink" name="links"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid" data-kt-select2="true" name="kategori"
                                data-placeholder="Select option" data-dropdown-parent="#kt_modal_add_videos"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <div class="position-relative d-flex align-items-center"
                                ...
                                <span class="svg-icon svg-icon-2 position-absolute mx-4" style="top: 12px; right:0px;">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input class="form-control form-control-solid" id="tags" name="tags"
                    ...
                    <div class="text-center pt-5">
                        <button type="reset" class="btn btn-light me-3"
                            data-kt-videos-modal-action="cancel">Discard</button>
                        <button type="submit" class="btn btn-primary" data-kt-videos-modal-action="submit">

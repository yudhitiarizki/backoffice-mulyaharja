...
@section('content')
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Categories
                        <!--begin::Separator-->
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" data-kt-category-table-filter="search" id="search-table"
                                            ...
                                            <td>
                                                <div
                                                    ...
                                                    <a href="#" data-id="{{ $item->id }}"
                                                        ...
                                                        data-bs-target="#kt_modal_update_category"><i
    ...
    @include('main.category.modal-create')
    @include('main.category.modal-update')
...
@section('script')
    ...
    <script>
        $('.mdl-delete').click(function() {
            $('#from-delete').attr('action', '/category/' + $(this)
                .attr('data-id'))
        });

        $('.mdl-update').click(function() {
            $('#kt_modal_update_category_form').attr('action', '/category/' + $(this)
                .attr('data-id'))
            $.ajax({
                type: "GET",

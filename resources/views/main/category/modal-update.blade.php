    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-5 my-1">
                <!--begin::Form-->
                <form id="kt_modal_update_category_form" class="form" action="/category" method="POST"
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_category_scroll"
                        ...
                        data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_category_header"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea type="email" name="description" class="form-control form-control-solid mb-3 mb-lg-0"

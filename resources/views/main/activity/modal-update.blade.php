...
<div class="modal fade" id="kt_modal_update_activity" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="kt_modal_update_activity_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Update Activity</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-activity-modal-action="close">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-5 my-1">
                <!--begin::Form-->
                <form id="kt_modal_update_activity_form" class="form" action="/activity" method="POST"
                    enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_activity_scroll"
                        data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}"
                        data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_update_activity_header"
                        data-kt-scroll-wrappers="#kt_modal_update_activity_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid" data-kt-select2="true" name="kategori"
                                ...
                                data-dropdown-parent="#kt_modal_update_activity" data-allow-clear="true">
                                <option></option>
                    ...
                    <div class="text-center pt-5">
                        <button type="reset" class="btn btn-light me-3"
                            data-kt-activity-modal-update-action="cancel">Discard</button>
                        <button type="submit" class="btn btn-primary" data-kt-activity-modal-update-action="submit">

    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_activity_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Add Activity</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <!--end::Modal header-->
            <!--begin::Modal body-->
            <div class="modal-body scroll-y mx-5 mx-xl-5 my-1" id="kt_modal_body_add_activity">
                <!--begin::Form-->
                <form id="kt_modal_add_activity_form" class="form" action="/activity" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_activity_scroll"
                        data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}"
                        data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_activity_header"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid" data-kt-select2="true" name="kategori"
                                data-placeholder="Select option" data-dropdown-parent="#kt_modal_add_activity"
                                ...
                                <span class="svg-icon svg-icon-2 position-absolute mx-4" style="top: 12px; right:0px;">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path d="M16 2V5" stroke="#BEBEBE" stroke-width="1.5" stroke-miterlimit="10"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path opacity="0.4" d="M3.5 9.08984H20.5" stroke="#BEBEBE" stroke-width="1.5"
                    ...
                    <div class="text-center pt-5">
                        <button type="reset" class="btn btn-light me-3"
                            data-kt-activity-modal-action="cancel">Discard</button>
                        <button type="submit" class="btn btn-primary" data-kt-activity-modal-action="submit">

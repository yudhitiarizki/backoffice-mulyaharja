...
@section('content')
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Activity
                        <!--begin::Separator-->
                ...
                <div class="card">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-activity-table-filter="search" id="search-table"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="Search activity" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-activity-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_add_activity">
                                    ...
                                    <!--end::Svg Icon-->Add Activity</button>
                                <!--end::Add activity-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
                    ...
                    <div class="card-body py-4">
                        <div class="w-100 table-responsive">
                            ...
                            <!--begin::Table-->
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_activity">
                                <!--begin::Table head-->
                                <thead>
                                    <!--begin::Table row-->
                                            ...
                                            <td>
                                                <div
                                                    ...
                                                    <a href="#" data-id="{{ $item->id }}"
                                                        ...
                                                        data-bs-target="#kt_modal_update_activity"><i
    ...
    @include('main.activity.modal-create')
    @include('main.activity.modal-update')
...
@section('script')
    ...
    <script>
        ...
        $('.mdl-delete').click(function() {
            $('#from-delete').attr('action', '/activity/' + $(this)
                .attr('data-id'))
        });
        ...
        $('.mdl-update').click(function() {
            $('#kt_modal_update_activity_form').attr('action', '/activity/' + $(this).attr('data-id'));
            $.ajax({
                type: "GET",

...
@section('content')
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" data-kt-product-table-filter="search" id="search-table"
                        ...
                        <div class="card-toolbar gap-3">
                            ...
                            <div class="d-flex justify-content-end align-items-center"">
                                <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_category">
                                            ...
                                            <td>
                                                <div
                                                    ...
                                                    <a href="#" data-id="{{ $item->id }}"
                                                        ...
                                                        data-bs-target="#kt_modal_update_product"><i
    ...
    @include('main.product.modal-create')
    @include('main.product.modal-update')
    @include('main.product.modal-category')
...
@section('script')
    ...
    <script>
        ...
        $('.mdl-delete').click(function() {
            $('#from-delete').attr('action', '/product/' + $(this)
                .attr('data-id'))
        });

        $('.mdl-delete-category').click(function() {
            $('#from-delete').attr('action', '/product/category/' + $(this)
                .attr('data-id'))
        });
        ...
        $('.mdl-update').click(function() {
            $('#kt_modal_update_product_form').attr('action', '/product/' + $(this).attr('data-id'));
            $.ajax({
                type: "GET",
                ...
                success: (response) => {
                    ...
                    $('#addtional_info').val(response.addtional_info);
                    $('#kategori').val(response.product_category_id).trigger('change');

                    if (descriptionEditor) descriptionEditor.setData(response.description);
        ...
        $('.mdl-update-category').click(function() {
            $('#kt_modal_update_category_form').attr('action', '/product/category/' + $(this).attr('data-id'));

    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_news_header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Add News</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <!--end::Modal header-->
            <!--begin::Modal body-->
            <div class="modal-body scroll-y mx-5 mx-xl-5 my-1" id="kt_modal_body_add_news">
                <!--begin::Form-->
                <form id="kt_modal_add_news_form" class="form" action="/news" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_news_scroll"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid" data-kt-select2="true" name="kategori"
                                data-placeholder="Select option" data-dropdown-parent="#kt_modal_add_news"
                    ...
                    <div class="text-center pt-5">
                        <button type="reset" class="btn btn-light me-3"
                            data-kt-news-modal-action="cancel">Discard</button>
                        <button type="submit" class="btn btn-primary" data-kt-news-modal-action="submit">

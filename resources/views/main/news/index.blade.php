...
@section('content')
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" data-kt-news-table-filter="search" id="search-table"
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-news-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    ...
                                    <!--end::Svg Icon-->Add News</button>
                                <!--end::Add news-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
                            <div class="d-flex justify-content-end align-items-center d-none"
                                data-kt-news-table-toolbar="selected">
                                <div class="fw-bolder me-5">
                                    <span class="me-2" data-kt-news-table-select="selected_count"></span>Selected
                                </div>
                                <button type="button" class="btn btn-danger"
                                    data-kt-news-table-select="delete_selected">Delete Selected</button>
                            </div>
                            <!--end::Group actions-->
                                            ...
                                            <td class="text-end">
                                                <div
                                                    ...
                                                    <a href="#" data-id="{{ $item->id }}"
                                                        ...
                                                        data-bs-target="#kt_modal_update_news"><i
    ...
    @include('main.news.modal-create')
    @include('main.news.modal-update')
...
@section('script')
    ...
    <script>
        ...
        $('.mdl-delete').click(function() {
            $('#from-delete').attr('action', '/news/' + $(this)
                .attr('data-id'))
        });
        ...
        $('.mdl-update').click(function() {
            $('#kt_modal_update_news_form').attr('action', '/news/' + $(this).attr('data-id'));
            $.ajax({
                type: "GET",
                url: "/news/" + $(this).attr('data-id'),
                success: (response) => {

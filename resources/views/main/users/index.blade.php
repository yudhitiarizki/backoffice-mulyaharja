...
@section('content')
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" data-kt-user-table-filter="search" id="search-table"
                                    ...
                                    @foreach ($data as $idx => $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form class="form-check form-switch form-check-custom form-check-solid"
                                                    action="/users/active/{{ $item->id }}" method="POST">
                                                    @method('PUT')
                                                    @csrf
                                            ...
                                            <td class="text-end">
                                                <div
                                                    ...
                                                    <a href="#" data-id="{{ $item->id }}"
                                                        ...
                                                        data-bs-target="#kt_modal_update_user"><i
    ...
    @include('main.users.modal-create')
    @include('main.users.modal-update')
...
@section('script')
    ...
    <script>
        $('.mdl-delete').click(function() {
            $('#from-delete').attr('action', '/users/' + $(this)
                .attr('data-id'))
        });

        $('.mdl-update').click(function() {
            $('#kt_modal_update_user_form').attr('action', '/users/' + $(this)
                .attr('data-id'))
            $.ajax({
                type: "GET",
                ...
                success: function(response) {
                    ...
                    $(".image-input-wrapper").css('backgroundImage', "url('" + response.image_url +
                        "')")
                }
            });
        });

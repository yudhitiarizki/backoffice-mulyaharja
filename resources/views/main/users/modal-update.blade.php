    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-5 my-1">
                <!--begin::Form-->
                <form id="kt_modal_update_user_form" class="form" action="/users/" method="POST"
                    ...
                    <div class="text-center pt-5">
                        <button type="reset" class="btn btn-light me-3"
                            data-kt-users-modal-update-action="cancel">Discard</button>
                        <button type="submit" class="btn btn-primary" data-kt-users-modal-update-action="submit">

...
<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="/"
                class="d-flex align-items-center justify-content-center gap-3 d-lg-none text-white fw-bolder">
                <img alt="Logo" src="{{ asset('assets/media/logos/logo.png') }}"
                    class="h-25px logo bg-white rounded-circle" />
                MULYAHARJA
            </a>
        </div>
        <!--end::Mobile logo-->
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            ...
            <div class="topbar d-flex align-items-stretch flex-shrink-0">
                ...
                {{-- <div class="d-flex align-items-stretch">
                    <!--begin::Menu wrapper-->
                    <div class="topbar-item px-3 px-lg-5 position-relative" data-kt-menu-trigger="click"
